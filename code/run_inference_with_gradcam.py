...
def main(_):
  ...
  man_id = vocab.word_to_id('man')
  woman_id = vocab.word_to_id('woman')
  male_id = vocab.word_to_id('male')
  female_id = vocab.word_to_id('female')
  men_id = vocab.word_to_id('men')
  women_id = vocab.word_to_id('women')
  boy_id = vocab.word_to_id('boy')
  girl_id = vocab.word_to_id('girl')
  people_id = vocab.word_to_id('people')
